define([], function () {
    ...
    /* Watch modifications by Charlie Hargood 2015 (cah07r@ecs.soton.ac.uk)*/
    ...
    var geolocator = function () {
         ...
         */
        function getPosition(fallbackToIP, html5Options, watch) {
        ...
        return {
             ...
             */
            locate: function (successCallback, errorCallback, fallbackToIP, html5Options, mapCanvasId, watch) {
                onSuccess = successCallback;
                onError = errorCallback;
                mCanvasId = mapCanvasId;
                //function gLoadCallback() { getPosition(fallbackToIP, html5Options, watch); }
                //loadGoogleMaps(gLoadCallback);
            },
